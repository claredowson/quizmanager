...
if(count($_POST)>0) {
    ...
    pg_query($dbconn,"UPDATE general set id='" . $_POST['id'] . "', question='" . $_POST['question'] . "', choice_1='" . $_POST['choice_1'] . "', choice_2='" . $_POST['choice_2'] . "' ,choice_3='" . $_POST['choice_3'] . "', choice_4='" . $_POST['choice_4'] . "', answer='" . $_POST['answer'] . "' WHERE id='" . $_POST['id'] . "'");
    echo "$post[question]";
    echo "<script> location.href='generaledits.php'</script>";
}
    
    $result = pg_query($dbconn,"SELECT * FROM general WHERE id='" . $_GET['id'] . "'");
...
<div>
<a href="generaledits.php">Back to Question List</a>
</div>
